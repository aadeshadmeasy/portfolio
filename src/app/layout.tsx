...
import { Playfair_Display, Press_Start_2P, VT323 } from "next/font/google";
import "./globals.css";
...
export default function RootLayout({ children }: LayoutProps<"/">) {
  return (
    <html lang="en" className={`${pressStart.variable} ${vt323.variable} ${playfair.variable} h-full`} suppressHydrationWarning>
